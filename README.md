...
| camera_motion_detection_enabled          | Activate camera based motion detection? Screensaver is stopped when movement is detected See [Camera motion detection](#camera-motion-detection) for details. | false      |
