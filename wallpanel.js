  ...
  if (isObject(target) && isObject(source)) {
    var _loop = function _loop() {
      ...
      if (isObject(val)) {
        ...
        var replacer = function replacer(match, entityId) {
...
function setSidebarVisibility(hidden) {
  ...
  try {
    var aside = elHaMain.shadowRoot.querySelector("ha-drawer").shadowRoot.querySelector("aside");
  ...
  var WallpanelView = /*#__PURE__*/function (_HuiView) {
    ...
    return _createClass(WallpanelView, [{
      ...
      value: function setMediaDataInfo() {
        ...
        if (html == "analyze") {
          var _iterateOverKeys = function iterateOverKeys(obj) {
